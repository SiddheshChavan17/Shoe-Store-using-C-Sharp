...
namespace FinalShoeStore {
    ...
    public partial class EmployeeDBDataSet : global::System.Data.DataSet {
        ...
        public partial class employeeDataTable : global::System.Data.TypedTableBase<employeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public employeeRow AddemployeeRow(string Emp_Name, int Contact, string _E_Mail, string Address) {
            ...
            private void InitClass() {
                ...
                this.columnEmp_Name.MaxLength = 536870910;
        ...
        public partial class employeeRow : global::System.Data.DataRow {
            ...
            public string _E_Mail {
                get {
                    try {
                        return ((string)(this[this.tableemployee._E_MailColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'E-Mail\' in table \'employee\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableemployee._E_MailColumn] = value;
                }
            }
            ...
            public bool Is_E_MailNull() {
                return this.IsNull(this.tableemployee._E_MailColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void Set_E_MailNull() {
                this[this.tableemployee._E_MailColumn] = global::System.Convert.DBNull;
            }
...
namespace FinalShoeStore.EmployeeDBDataSetTableAdapters {
    ...
    public partial class employeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `employee` WHERE ((`Emp_ID` = ?) AND ((? = 1 AND `Contact` IS NULL) O" +
                "R (`Contact` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `employee` (`Emp_Name`, `Contact`, `E-Mail`, `Address`) VALUES (?, ?," +
                " ?, ?)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Emp_Name", global::System.Data.OleDb.OleDbType.LongVarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Emp_Name", global::System.Data.DataRowVersion.Current, false, null));
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `employee` SET `Emp_Name` = ?, `Contact` = ?, `E-Mail` = ?, `Address` = ? " +
                "WHERE ((`Emp_ID` = ?) AND ((? = 1 AND `Contact` IS NULL) OR (`Contact` = ?)))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Emp_Name", global::System.Data.OleDb.OleDbType.LongVarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Emp_Name", global::System.Data.DataRowVersion.Current, false, null));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=|DataDirectory|\\EmployeeDB.accdb";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Emp_ID, Emp_Name, Contact, [E-Mail], Address FROM employee";
        ...
        public virtual int Delete(int Original_Emp_ID, global::System.Nullable<int> Original_Contact) {
        ...
        public virtual int Insert(string Emp_Name, global::System.Nullable<int> Contact, string _E_Mail, string Address) {
            if ((Emp_Name == null)) {
        ...
        public virtual int Update(string Emp_Name, global::System.Nullable<int> Contact, string _E_Mail, string Address, int Original_Emp_ID, global::System.Nullable<int> Original_Contact) {
            if ((Emp_Name == null)) {

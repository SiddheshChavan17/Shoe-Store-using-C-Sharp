...
namespace FinalShoeStore {
    ...
    public partial class ProductDBDataSet : global::System.Data.DataSet {
        ...
        public partial class productDataTable : global::System.Data.TypedTableBase<productRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public productRow AddproductRow(string Product_Name, string Brand, decimal Price, int Quantity) {
...
namespace FinalShoeStore.ProductDBDataSetTableAdapters {
    ...
    public partial class productTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `product` WHERE ((`Product_ID` = ?) AND ((? = 1 AND `Price` IS NULL) " +
                "OR (`Price` = ?)) AND ((? = 1 AND `Quantity` IS NULL) OR (`Quantity` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `product` (`Product_Name`, `Brand`, `Price`, `Quantity`) VALUES (?, ?" +
                ", ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `product` SET `Product_Name` = ?, `Brand` = ?, `Price` = ?, `Quantity` = ?" +
                " WHERE ((`Product_ID` = ?) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)) AN" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=|DataDirectory|\\ProductDB.accdb";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Product_ID, Product_Name, Brand, Price, Quantity FROM product";
        ...
        public virtual int Delete(int Original_Product_ID, global::System.Nullable<decimal> Original_Price, global::System.Nullable<int> Original_Quantity) {
        ...
        public virtual int Insert(string Product_Name, string Brand, global::System.Nullable<decimal> Price, global::System.Nullable<int> Quantity) {
        ...
        public virtual int Update(string Product_Name, string Brand, global::System.Nullable<decimal> Price, global::System.Nullable<int> Quantity, int Original_Product_ID, global::System.Nullable<decimal> Original_Price, global::System.Nullable<int> Original_Quantity) {
            if ((Product_Name == null)) {
